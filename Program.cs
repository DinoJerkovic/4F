...
namespace BA4F
{
    class Program
    {
        ...
        public static int Score(string peptide, List<int> spectrum)
        {
            ...
            {
                if(spectrum.Contains(z))//ako je sadrzan,ostatak sam napravio na osnovu teksta ispod zadatka
                    {
        ...
        static void Main(string[] args)
        {
           List<int>spectrum=new List<int>();
            ...
            //kopirao sam od prethodnih svojih zadataka sve funkcije osim funkcije score
           Console.ReadLine();
            }
    }
}
